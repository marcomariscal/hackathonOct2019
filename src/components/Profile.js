...
class Profile extends Component {
  ...
  loadTasks() {
    ...
    this.props.userSession.getFile(TASKS_FILENAME, options).then(content => {
      if (content) {
  ...
  saveTasks(tasks) {
    ...
    this.props.userSession.putFile(
      TASKS_FILENAME,
    ...
    return (
      <div className="Dashboard">
        ...
        <div className="row justify-content-center" id="header">
          <h3 className="user-info">{username}'s shared songs</h3>
        </div>
        <br></br>
